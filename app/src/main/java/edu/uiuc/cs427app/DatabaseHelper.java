...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_NAME = "real_name";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createUsersTable = "CREATE TABLE " + TABLE_USERS + " (" +
                ...
                COLUMN_NAME + " TEXT, " +     // New Column
                COLUMN_BIO + " TEXT, " +      // New Column
                COLUMN_CITIES + " TEXT" +
                ");";
    ...
    public User getUserByUsername(String username) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int bioIdx = cursor.getColumnIndex(COLUMN_BIO);
            ...
            if (userIdIndex != -1 && usernameIndex != -1 && passwordHashIndex != -1) {
                ...
                if (nameIdx != -1) user.setName(cursor.getString(nameIdx));
...
//        db.close();
     ...
     * * @param username The username to identify the record
     * @param name The new display name
     * @param bio The new biography text
     * @return true if successful
     */
    public boolean updateUserProfile(String username, String name, String bio) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
